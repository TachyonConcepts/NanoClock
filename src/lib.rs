...
#[inline(always)]
fn _nano_clock_rs(mut z: i64) -> (i32, u8, u8, u8, u8, u8, u8) {
...
#[inline(always)]
unsafe fn _nano_clock_asm(z: i64) -> (i32, u8, u8, u8, u8, u8, u8) {
    let mut out = YMDHMSW {
        y: 0,
        m: 0,
        d: 0,
...
#[inline(always)]
pub fn nano_clock() -> (i32, u8, u8, u8, u8, u8, u8) {
...
#[inline(always)]
pub unsafe fn nano_http_date(buf: &mut [u8; 35], use_asm: bool) {
    ...
    let (year, mon, mday, hh, mm, ss, wday): (i32, u8, u8, u8, u8, u8, u8) = match use_asm {
        true => nano_clock_asm(), // Welcome to Mordor
        false => nano_clock(),    // Slightly less cursed
    };
    unsafe {
